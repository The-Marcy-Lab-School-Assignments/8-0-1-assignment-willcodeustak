...
var ot = {
	...
	rf = we(tf),
	lf = V({}, Gt, { relatedTarget: 0 }),
	Pl = we(lf),
	of = V({}, ot, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
	uf = we(of),
	sf = V({}, ot, {
...
function ti() {
	_t && (_t.detachEvent('onpropertychange', $s), (jt = _t = null));
}
function $s(e) {
	if (e.propertyName === 'value' && rl(jt)) {
		var n = [];
		Fs(n, jt, e, Xo(e)), gs(Lf, n);
	}
}
function Rf(e, n, t) {
	e === 'focusin'
		? (ti(), (_t = n), (jt = t), _t.attachEvent('onpropertychange', $s))
		: e === 'focusout' && ti();
}
function Of(e) {
...
function vn() {
	if (!jl && Ve !== null) {
		...
		try {
			...
			throw (Ve !== null && (Ve = Ve.slice(e + 1)), Es(Go, vn), l);
		} finally {
			(O = n), (jl = !1);
		}
	}
...
function Sa(e, n, t) {
	return Pn & 21
		? (Me(t, n) || ((t = xs()), ($.lanes |= t), (zn |= t), (e.baseState = !0)),
		  n)
...
function bf(e, n, t) {
	...
	if (Ea(e)) Ca(n, l);
		...
		(t = ra(e, n, l, r)),
			t !== null && ((l = ue()), Oe(t, e, r, l), _a(t, n, r));
	}
}
function Ea(e) {
	var n = e.alternate;
...
function zi(e, n, t, r, l) {
	...
	if ((Gn(n, l), n.stateNode === null))
		xr(e, n), xa(n, t, r), Co(n, t, r, l), (r = !0);
	else if (e === null) {
		var u = n.stateNode,
			i = n.memoizedProps;
		u.props = i;
...
function id(e, n, t) {
	...
	switch ((ou(n), n.tag)) {
				...
				(e === null || e.child === null) &&
					(fr(n)
						...
						: e === null ||
						  ...
						  ((n.flags |= 1024), Te !== null && (Fo(Te), (Te = null)))),
				Lo(e, n),
				ne(n),
				null
			);
		...
		case 4:
			return (
				nt(), Lo(e, n), e === null && Ut(n.stateNode.containerInfo), ne(n), null
			);
		case 10:
...
function cd(e, n) {
	...
	for (mo = { focusedElem: e, selectionRange: t }, Dr = !1, k = n; k !== null; )
...
function Fa(e) {
	...
	n !== null && ((e.alternate = null), Fa(n)),
		...
		e.tag === 5 &&
			((n = e.stateNode),
			n !== null &&
				(delete n[je], delete n[Vt], delete n[yo], delete n[Kf], delete n[Yf])),
		(e.stateNode = null),
		(e.return = null),
		(e.dependencies = null),
...
hs = _u;
ys = Ln;
var Nd = { usingClientEntryPoint: !1, Events: [Zt, Un, ol, ms, vs, _u] },
	ht = {
...
const Ld = '/assets/react-CHdo91hT.svg',
	Td = '/vite.svg';
function Rd() {
...
ec(document.getElementById('root')).render(
	le.jsx(el.StrictMode, { children: le.jsx(Rd, {}) })
);
